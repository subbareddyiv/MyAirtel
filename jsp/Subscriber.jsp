...
<script language="javascript" type="text/javascript" >
	function setSubmit(SubscriberForm)
	{
		...
		if( subname == null || subname == "")
		{
			...
			document.SubscriberForm.subname.focus();
			return false;
		}
		else if( mobno == null || mobno == "")
		{
			alert("Mobile Number should be Mandatory.");
			document.SubscriberForm.mobno.focus();
			return false;
		}
		else if( isNaN(mobno) )
		{
		...
		else if( simid == null || simid == "")
		{
			...
			document.SubscriberForm.simid.focus();
			return false;
		}
		else if( isNaN(simid) )
		{
		...
		else if( address == null || address == "")
		{
			...
			document.SubscriberForm.address.focus();
			return false;
		}
		else if( doctype == null || doctype == "")
		{
			alert("Document should be Mandatory.");
			document.SubscriberForm.doctype.focus();
			return false;
		}
		else
		{
...
<form action="/airtel/addsubinfo" method="post" name="SubscriberForm" >
<table align="center">
