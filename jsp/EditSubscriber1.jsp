...
<table width="680" border="1" align="center">
  ...
  <tr>
    ...
    <td bgcolor="#CCCCCC"><a href="jsp/editsubdetails.jsp?id=<%=rs.getInt(1)%>" class="style8">Edit</a>/<a href="jsp/deletesubdetails.jsp?id=<%=rs.getInt(1)%>" class="style8">Delete</a></td>
  </tr>
  <%}%>
</table>
