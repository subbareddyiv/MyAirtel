...
<table width="568" border="1" align="center" bordercolor="#999999">
  <tr>
  ...
  <tr>
    ...
    <td bgcolor="#CCCCCC"><a href="/airtel/jsp/editoutdetails.jsp?id=<%=rs.getInt(1)%>" class="style8">Edit</a>/<a href="/ai	rtel/jsp/deleteoutdetails.jsp?id=<%=rs.getInt(1)%>" class="style8">Delete</a></td>
  </tr>
  <%}%>
</table>
