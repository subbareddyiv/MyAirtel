...
<td>
<p>&nbsp;</p><p>&nbsp;</p>
<p align="center"><span class="style1 style17"><font color="#CC0066"><u>Card Details</u></font></span></p>


<table width="350" border="1" align="center" bordercolor="#999999">
  <tr>
    <td width="109"><div align="center" class="style23">
      <div align="center">Card Name</div>
    </div></td>
    <td width="59"><div align="center"><span class="style23">Amount</span></div></td>
    <td width="94"><div align="center"><span class="style23">Actuals</span></div></td>
    ...
    <%
			...
			ResultSet rs = stmt.executeQuery("select * from cardtype");
			while(rs.next())
			{
  %>
  <tr><%
  %>
    ...
    <td bgcolor="#CCCCCC"><a href="/airtel/jsp/editcarddetails.jsp?id=<%=rs.getInt(1)%>" class="style8">Edit</a>/<a href="/ai	rtel/jsp/deletecarddetails.jsp?id=<%=rs.getInt(1)%>" class="style8">Delete</a></td>
  </tr>
  <%}%>
</table>
