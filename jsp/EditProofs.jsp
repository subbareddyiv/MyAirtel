...
<table width="226" border="1" align="center">
  <tr>
    <td width="142"><div align="center"><strong><span class="style16">Document Name</span></strong></div></td>
  ...
  <tr>
    ...
    <td bgcolor="#CCCCCC"><a href="/airtel/jsp/editproofdetails.jsp?id=<%=rs.getInt(1)%>" class="style8">Edit</a>/<a href="/ai	rtel/jsp/deleteproofdetails.jsp?id=<%=rs.getInt(1)%>" class="style8">Delete</a></td>
  </tr>
  <%}%>
</table>
