...
<td>
<p>&nbsp;</p><p>&nbsp;</p>
<p align="center" ><span class="style1"><font color="#CC0066"><u>Distributor Details Entry Process</u></font></span></p>
<form action="/airtel/distinfo" method="POST" name="DistributorForm" >
<table align="center">

<tr><td align=right><b><font size=4>Distributor Code&nbsp;&nbsp;</b></td>
	<td align=left >&nbsp;&nbsp;<input type="text" name="distcode" size="20" ></td></tr>

<tr><td align=right><b><font size=4>GL Code&nbsp;&nbsp;</b></td>
	<td align=left >&nbsp;&nbsp;<input type="text" name="glcode" size="20" ></td></tr>

<tr><td align=right><b><font size=4>Region Name&nbsp;&nbsp;</b></td>
	<td align=left >&nbsp;&nbsp;<input type="text" name="region" size="20" ></td></tr>

<tr><td align=right><b><font size=4>District Name&nbsp;&nbsp;</b></td>
	<td align=left >&nbsp;&nbsp;<input type="text" name="district" size="20" ></td></tr>

<tr><td align=right><b><font size=4>Hub Name&nbsp;&nbsp;</b></td>
	<td align=left >&nbsp;&nbsp;<input type="text" name="hub" size="20" ></td></tr>

<tr><td align=right valign="top" ><b><font size=4>Address&nbsp;&nbsp;</b></td>
	<td align=left >&nbsp;&nbsp;<textarea name="address" rows="5" cols="15" ></textarea></td></tr>
