...
<td>
<p>&nbsp;</p><p>&nbsp;</p>
<p align="center"><span class="style1 style17"><font color="#CC0066"><u>Distributor Details</u></font></span></p>
...
<table width="645" border="1" align="center">
  ...
  <tr>
    ...
    <td bgcolor="#CCCCCC"><a href="/airtel/jsp/editdistdetails.jsp?id=<%=rs.getInt(1)%>" class="style8">Edit</a>/<a href="/airtel/jsp/deletedistdetails.jsp?id=<%=rs.getInt(1)%>" class="style8">Delete</a></td>
  </tr>
  <%}%>
</table>
